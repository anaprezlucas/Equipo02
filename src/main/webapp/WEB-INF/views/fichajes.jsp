						...
						<div class="historial-div collapse.in col-md-5 col-md-offset-1" id="panelFichajes">
									...
									<form id="formListar" action="consultaFichajesFechaGeneral" method="get" data-toggle="validator">
												...
												<fieldset class="form-group">
															...
															<input placeholder="yyyy-MM-dd" type="text"  pattern="([0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" name="fecha1" id="fecha1" data-error="Formato de fecha err&oacute;neo" required/>
															 <div class="help-block with-errors"></div>
															<label>Introduzca segunda fecha del periodo de fichajes:<br></label> 
															<input placeholder="yyyy-MM-dd" type="text" pattern="([0-9]{4}-(0[1-9]|1[012])-(0[1-9]|1[0-9]|2[0-9]|3[01])" name="fecha2" id="fecha2" data-error="Formato de fecha err&oacute;neo" required/>
															 <div class="help-block with-errors"></div>
